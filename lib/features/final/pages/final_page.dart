                ...
                children: [
                  ...
                  Center(
                    child: SizedBox(
                        width: 180,
                        height: 180,
                        child: Image(image: getIt<PNGResourceManager>().getAssetWidget(Resource.congratsIcon))),
                  ),
                  const SizedBox(height: 40),
                  const Text("Untuk mengulangi pembelajaran, silahkan KLIK tombol “Ulangi Pembelajaran”",
            ...
            child: MaxWidthBox(
              ...
              child: SizedBox(
                ...
                child: TextButton(
                    ...
                    child:  const Text("Ulangi Pembelajaran",
                    )),
              ),
            ),
          ),
